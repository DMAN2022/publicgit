...
description: Add a guest user to a role in Azure Active Directory adfasdfadsf
...
# Grant permissions to users from partner organizations in your Azure Active Directory tenant TESTING outi
